  ...
  return (
    ...
    >
      <div className="flex justify-center items-center border-r">
        <div className="aspect-square bg-foreground/20 h-14 w-14 rounded-l-md relative overflow-hidden">
          {imageError ? (
            ...
            <img
              ...
              alt={track.title}
              className="h-14 w-14 aspect-square object-cover rounded-l-md shrink-0 scale-140"
